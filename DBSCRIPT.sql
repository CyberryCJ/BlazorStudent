...
insert  into `tblstudinfo`(`Id`,`Fname`,`Mi`,`Lname`,`Birthday`,`Address`,`Email`,`UserName`,`Pwd`) values 
('1','Jerry','O','Mates','1987-10-14','Polomolok, South Cotabato.','Jerry_Mates_Jr@yahoo.com','User','adminadmin'),
('5','Jaxen Cyry','N','Mates','2015-09-22','Polomolok, South Cotabato.','Jaxen@gmail.com','admin','adminadmin');
